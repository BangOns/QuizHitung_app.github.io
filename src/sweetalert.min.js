!(function (e, t) {
      ...
      p.buttonsStyling
        ? (A([l, u, d], m.styled),
          p.confirmButtonColor &&
            ...
            A(l, m["default-outline"])),
          p.denyButtonColor &&
            ((u.style.backgroundColor = p.denyButtonColor),
            A(u, m["default-outline"])),
          p.cancelButtonColor &&
            ((d.style.backgroundColor = p.cancelButtonColor),
            A(d, m["default-outline"])))
        : k([l, u, d], m.styled),
        o.reverseButtons &&
          (o.toast
  ...
  const Te = [
    ...
    Ie =
      ((S.text =
        ...
        S.url =
          (e, t) => (
            He(e, t.inputValue), je(e, e, t), Oe(e, t), (e.type = t.input), e
          )),
    ...
    _e = (e, t) => {
      ...
      ((n.className = ""
        .concat(m.popup, " ")
        .concat(x(n) ? o.showClass.popup : "")),
      o.toast)
        ? (A([document.documentElement, document.body], m["toast-shown"]),
          A(n, m.toast))
        : A(n, m.modal);
          ...
          n.progressSteps.forEach((e, t) => {
            ...
            o.appendChild(e),
              ...
              t !== n.progressSteps.length - 1 &&
                ((e = ((e) => {
                  const t = document.createElement("li");
                  if ((A(t, m["progress-step-line"]), e.progressStepsDistance))
  ...
  function Je() {
    ...
    n &&
      ...
      ee()
        ? n.icon && B(r())
        : (t = (n = e).popup.getElementsByClassName(
      ...
      if (o && !n.isComposing && 229 !== n.keyCode)
        if (
          ...
          if (
            ...
            [e, c, l].includes(document.activeElement)
          ) {
            var u = et.includes(s)
              ? "nextElementSibling"
      ...
      return (
        ...
        (n === o ||
          (!le(o) &&
            ...
            "INPUT" !== n.tagName &&
            !("TEXTAREA" === n.tagName || (le(z()) && z().contains(n)))))
      );
    },
    ct = () => {
      var e;
  ...
  const mt = (e) => {
      e.isAwaitingPromise() &&
        (p.awaitingPromise.delete(e), p.innerParams.get(e) || e._destroy());
    },
    gt = (e, t, n) => {
      var o,
        i,
  ...
  const O = {
    ...
    Bt = (e) => {
      ...
      for (const n in e)
        (t = n),
          Ct(t) || a('Unknown parameter "'.concat(t, '"')),
          e.toast &&
            ((t = n),
            wt.includes(t) &&
  ...
  const Pt = (e) => {
      e.isAwaitingPromise()
        ? (xt(p, e), p.awaitingPromise.set(e, !0))
        : (xt(ot, e), xt(p, e));
    },
    xt = (e, t) => {
      ...
      if (n.input) {
        ...
        if (n.inputValidator) {
          ...
          c.then((e) => {
            i.enableButtons(),
              i.enableInput(),
              e ? i.showValidationMessage(e) : ("deny" === r ? Mt : qt)(i, a);
          });
        } else
      ...
      t.container.onmousedown = () => {
        t.popup.onmouseup = function (e) {
          (t.popup.onmouseup = void 0),
            (e.target !== t.popup && !t.popup.contains(e.target)) || (Vt = !0);
        };
      };
    },
    Rt = (n, o, i) => {
      o.container.onclick = (e) => {
        ...
        Vt
          ? (Vt = !1)
          : e.target === o.container && F(t.allowOutsideClick) && i(L.backdrop);
      };
    },
    ...
    bindClickHandler: function () {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ...
          : "data-swal-template";
      (Yt[e] = this),
        _t || (document.body.addEventListener("click", Zt), (_t = !0));
    },
  });
  class Jt {
    constructor(e, t) {
  ...
  const Xt = ["swal-title", "swal-html", "swal-footer"],
      ...
      return (
        e &&
          ...
          e.hasAttribute("height") &&
            (t.imageHeight = e.getAttribute("height")),
    ...
    cn = (e) => {
      ...
      e.target === t &&
        ((e = g()),
        t.removeEventListener(ke, cn),
        (e.style.overflowY = "auto"));
    },
    ln = (e, t) => {
      ke && ue(t)
        ? ((e.style.overflowY = "hidden"), t.addEventListener(ke, cn))
        : (e.style.overflowY = "auto");
    },
    un = (e, t, n) => {
      rt(),
    ...
    dn = (e, t, n) => {
      A(e, n.showClass.backdrop),
        ...
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          A([document.documentElement, document.body], m["height-auto"]);
    };
  var pn = {
    email: (e, t) =>
  ...
  class I {
    ...
    _main(e) {
      var t =
        ...
        e =
          (Bt(Object.assign({}, t, e)),
          E.currentInstance && (E.currentInstance._destroy(), Q() && at()),
          (E.currentInstance = H),
          hn(e, t)),
        t =
          (mn(e),
  ...
  const gn = (l, u, d) =>
        ...
        ot.swalPromiseResolve.set(l, e),
          ...
          (u.denyButton.onclick = () => {
            ...
            (e = l),
              (t = p.innerParams.get(e)),
              e.disableButtons(),
              t.returnInputValueOnDeny ? jt(e, "deny") : Mt(e, !1);
          }),
    ...
    hn = (e, t) => {
      var n = (n =
          "string" == typeof (n = e).template
            ? document.querySelector(n.template)
            : n.template)
          ? ((n = n.content),
            rn(n),
            Object.assign(Gt(n), Qt(n), en(n), tn(n), nn(n), on(n), an(n, Xt)))
          : {},
        t = Object.assign({}, O, t, n, e);
      return (
        (t.showClass = Object.assign({}, O.showClass, t.showClass)),
        (t.hideClass = Object.assign({}, O.hideClass, t.hideClass)),
        t
      );
    },
    fn = (e) => {
